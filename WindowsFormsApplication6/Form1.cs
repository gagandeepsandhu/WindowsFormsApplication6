    ...
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            else if (radioButton2.Checked==true)
            {
                ...
                {
                    //this shows when bet is placed by all players.
                    MessageBox.Show("You already placed a bet");
                }
                else
                {
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            if (counter1 == 7)
            {
                ...
                //this message is shown when player win the bet.
                ...
                if (players == 0)
                {
                    // this shows when no one win the game.
                ...
                {
                    //this method show that bet is end and now no one can place bet.
